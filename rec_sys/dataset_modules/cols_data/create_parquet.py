...
from rec_sys.dataset_modules.cols_data.parquet_data_utils import build_review_dataset, load_metadata
...
def preprocess_to_parquet(
    ...
    """
    Загружает сырой датасет, строит векторизованные данные и сохраняет по пользователям в parquet.
    ...
    review_df = build_review_dataset(
        reviews_path=mus_file,
        metadata=metadata
    )
